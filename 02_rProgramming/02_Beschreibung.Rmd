...
## Untermenge von Daten
subset by [[c(RR,CC)]]
subset by $COL
subset by subset

## Daten bereinigen
clean vector (NA) by TF-counterVector
clean vector (NA) by complete cases
clean matrix (NA) by complete cases
clean matrix and select by subset
